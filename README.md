...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta**                                 | <br>Kael Lagos (TB1): Desarrolle la estructura del informe para comenzar con los primeros detalles del proyecto, además de definir los capítulos<br><br>Contenido hecho aqui<br>             |<br>Kael Lagos (TB1): Cosidero que este primer paso es muy importante para encaminar nuestro proyecto por el camino adecuado que aseguré nuestro exito en su desarrollo, como cualquier trabajo grupal la comunicación es lo más importante.<br><br>Conclusiones aqui<br> |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos.** | <br>Kael Lagos (TB1): <br>Solucionó algunos de los errores que se presentaron en el informe además de informar cualquier avance realizado en el trabajo o cualquier modificación hecha a sus compañeros. <br><br>Contenido hecho aqui<br>                                                             | <br>Kael Lagos (TB1): Siento que me he comunicado de gran forma con mi grupo, procuré darles una respuesta lo más rápida posible para evitar malentendidos y siempre anunciaba los cambios que le hacia al doc en el cual estabamos trabajando todos.<br> <br>Conclusiones aqui<br>  
...
| **Competidor**             | **OpenMind**                                                                                                    | **Wysa**                                                                                  | **Youper**                                                                        | **TalkLife**                                                                    |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| **Logo**                   | 🟦 Logo OpenMind                                                                                                | 🟦 Logo Wysa                                                                              | 🟦 Logo Youper                                                                    | 🟦 Logo TalkLife                                                                |
| **Perfil – Overview**      | Plataforma digital de apoyo psicológico personalizado (chatbot + conexión con profesionales).                   | App de IA con chatbot para apoyo emocional, utilizada por más de 5 millones de personas.  | Aplicación de salud mental con IA para seguimiento emocional y apoyo psicológico. | Red social de apoyo entre pares para salud mental, con enfoque en comunidad.    |
| **Ventaja Competitiva**    | Enfoque en jóvenes adultos, comunidades rurales y personas de bajos recursos; confidencialidad y accesibilidad. | IA muy desarrollada, disponible en varios idiomas, gran base de usuarios.                 | Uso de IA para personalizar conversaciones y sugerencias psicológicas.            | Comunidad global activa para compartir experiencias y apoyo entre usuarios.     |
| **Mercado Objetivo**       | Jóvenes (18-35), zonas rurales y sectores con menor acceso a salud mental.                                      | Personas jóvenes con acceso a smartphones, interesados en bienestar y salud emocional.    | Adultos jóvenes con interés en autoayuda y bienestar digital.                     | Adolescentes y jóvenes que buscan un espacio seguro para expresarse.            |
| **Estrategias de Marketing** | Campañas digitales, alianzas con ONGs, enfoque en accesibilidad en comunidades vulnerables.                     | Marketing global en tiendas de apps, presencia en medios de salud digital.                | Publicidad en plataformas digitales, alianzas con clínicas y terapeutas.          | Promoción como “la comunidad para la salud mental”, campañas en redes sociales. |
| **Productos & Servicios**  | Chatbot con soporte en texto, audio y video; conexión con psicólogos profesionales.                             | Chatbot basado en IA + ejercicios de terapia cognitivo-conductual (TCC).                  | Chatbot de IA + monitoreo de estado de ánimo + técnicas psicológicas.             | Comunidad tipo red social + recursos de autoayuda.                              |
| **Precios & Costos**       | Modelo freemium con planes accesibles y apoyo gratuito básico.                                                  | Freemium (funciones gratis, suscripción premium).                                         | Freemium con suscripción mensual.                                                 | Gratis con opción de donaciones/patrocinios.                                    |
| **Canales de Distribución**| App web y móvil.                                                                                                | App móvil (iOS y Android).                                                                | App móvil (iOS y Android).                                                        | App móvil (iOS y Android).                                                      |
| **Fortalezas**             | Innovación social, precios accesibles, enfoque en poblaciones vulnerables de LATAM.                             | IA avanzada, respaldo científico, alto número de usuarios.                                | IA personalizada, integración con psicología clínica.                             | Comunidad grande, interacción en tiempo real.                                   |
| **Debilidades**            | Poco reconocimiento, falta de alianzas iniciales, limitada experiencia internacional.                           | Puede carecer de conexión con psicólogos humanos, barreras de idioma en algunas regiones. | Dependencia del modelo de IA, menos enfoque comunitario.                          | Riesgo de no contar con supervisión profesional directa.                        |
| **Oportunidades**          | Expansión en LATAM, alianzas con universidades y ONGs, uso de IA inclusiva.                                     | Expansión a mercados emergentes, alianzas con instituciones de salud.                     | Crecimiento en terapias digitales personalizadas.                                 | Creciente interés en redes de apoyo mental entre jóvenes.                       |
| **Amenazas**               | Competencia global consolidada, riesgos regulatorios en salud digital.                                          | Competencia de nuevas apps de IA, regulación de datos.                                    | Regulaciones sobre uso de IA en salud.                                            | Riesgo de contenido dañino sin moderación adecuada.                             |
